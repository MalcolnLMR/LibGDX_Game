...
public class Eyes extends AbstractClothes {
	
	public static final int NEW_CLOTHE_INDEX = 7;

	public Eyes(DressMeUp game) {
		super(game);
		ref = "imgbtn_shirt";
	}
	
	public Eyes(DressMeUp game, String clothePath, String iconPath, String ref) {
